...
G4double RTPlanSource::GetSpotSize( ScanSpotData )
{
  ...
  /*else {
    G4Exception("RTPlanSource::GetSpotSize",
		"",
		FatalException,
		"Position distribution is not of type GmGenerDistPositionDisc or GmGenerDistPositionDiscGaussian");
    return 0.;
    } */
}

//-------------------------------------------------------------
void RTPlanSource::SetSpotSize( GmVGenerDistPosition2D* positionDistribution2D, const ScanSpotData& spdata )
{
  return;
