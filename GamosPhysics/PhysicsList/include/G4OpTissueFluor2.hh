...
#ifndef G4OpTissueFluor2_h
#define G4OpTissueFluor2_h 1
...
class G4OpTissueFluor2 : public G4VDiscreteProcess 
{
...
public: // Without description
  ...
  G4OpTissueFluor2(const G4String& processName = "OpTissueFluor2",
...
inline
G4bool G4OpTissueFluor2::IsApplicable(const G4ParticleDefinition& aParticleType)
{
   return ( &aParticleType == G4OpticalPhoton::OpticalPhoton() );
}

inline
G4PhysicsTable* G4OpTissueFluor2::GetIntegralTable() const
{
  return theIntegralTable;
}

inline
void G4OpTissueFluor2::DumpPhysicsTable() const
{
