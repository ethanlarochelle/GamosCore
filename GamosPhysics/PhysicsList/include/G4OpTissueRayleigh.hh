...
#ifndef G4OpTissueRayleigh_h
#define G4OpTissueRayleigh_h 1
...
class G4OpTissueRayleigh : public G4VDiscreteProcess 
{
...
private:
        ...
        // G4OpTissueRayleigh& operator=(const G4OpTissueRayleigh &right);
...
public: // Without description
        ...
        G4OpTissueRayleigh(const G4String& processName = "OpTissueRayleigh",
                              G4ProcessType type = fOptical);

        // G4OpTissueRayleigh(const G4OpTissueRayleigh &right);
...
inline
G4bool G4OpTissueRayleigh::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return ( &aParticleType == G4OpticalPhoton::OpticalPhoton() );
}

inline
void G4OpTissueRayleigh::DumpPhysicsTable() const
...
inline G4PhysicsTable* G4OpTissueRayleigh::GetPhysicsTable() const
{
  return thePhysicsTable;
}


#endif /* G4OpTissueRayleigh_h */
