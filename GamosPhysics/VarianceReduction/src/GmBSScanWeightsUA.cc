...
GmBSScanWeightsUA::GmBSScanWeightsUA()
{
  ...
  thePlaneZ = GmParameterMgr::GetInstance()->GetNumericValue("GmBSScanWeightsUA:PlaneZ", 1.*CLHEP::m );
  thePlaneHalfWidth = GmParameterMgr::GetInstance()->GetNumericValue("GmBSScanWeightsUA:PlaneHalfWidth", 10.*CLHEP::cm );
...
void GmBSScanWeightsUA::FillHistos( GmBSTrajectory* traj, G4int hid )
{
  ...
  theAnaMgr->GetHisto1(34000+100*hid+5)->Fill( theta/CLHEP::deg );
  theAnaMgr->GetHisto1(34000+100*hid+6)->Fill( phi/CLHEP::deg );
