...
public:
  ...
  float GetVoxelHalfX() const {
    G4cout << " SQDOSE GetVoxelHalfX " << (theVoxelLimitsX[theNoVoxelX]-theVoxelLimitsX[0])/theNoVoxelX/2. << " " << theVoxelLimitsX[theNoVoxelX] << " - " << theVoxelLimitsX[0] << ")/ " << theNoVoxelX << "/2." << G4endl; //GDEB
  ...
  float GetMaxX() const {
    return (theVoxelLimitsX[theNoVoxelX]); }
  float GetMaxY() const {
    return (theVoxelLimitsY[theNoVoxelY]); }
  float GetMaxZ() const {
    return (theVoxelLimitsZ[theNoVoxelZ]); }
