...
GmHistosGammaAtSD::GmHistosGammaAtSD()
{
  ...
  hnam = G4String("Energy lost ALL (keV)") ;
  theAnaMgr->CreateHisto1D(hnam,400,0,20000,103000+91);
  for( unsigned int ii = 0; ii < 6; ii++ ){
    ...
    theAnaMgr->CreateHisto1D(hnam,100,0,1000,103000+ii*100+11);
    ...
    theAnaMgr->CreateHisto1D(hnam,100,0,1000,103000+ii*100+21);
    ...
    theAnaMgr->CreateHisto1D(hnam,100,0,1000,103000+ii*100+41);
