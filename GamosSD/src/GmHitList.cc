...
if( SDVerb(infoVerb) ) G4cout << "GmHitList sdtype " << sdtype << " theDeadTime " << theDeadTime << G4endl;
  ...
  bParalyzable= G4bool(parmgr->GetNumericValue("SD:DeadTimeParalyzable:"+sdtype, 1)); 
  bParalyzable= G4bool(parmgr->GetNumericValue("SD:DeadTimeParalizable:"+sdtype, bParalyzable)); 
#ifndef GAMOS_NO_VERBOSE
