...
//--------------------------------------------------------------------
GmPSLETPhi::GmPSLETPhi(G4String name) 
...
//--------------------------------------------------------------------
G4bool GmPSLETPhi::ProcessHits(G4Step* aStep,G4TouchableHistory* th)
{
...
//--------------------------------------------------------------------
void GmPSLETPhi::SetParameters( const std::vector<G4String>& params)
{ 
  if( params.size() != 0 ){
    G4String parastr;
    ...
    G4Exception("GmPSLETPhi::SetParameters",
