# - Basic setup for packaging Gamos using CPack
...
#
set(CPACK_PACKAGE_DESCRIPTION "Gamos Toolkit")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Gamos Toolkit")
set(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_BINARY_DIR}/README.txt")
set(CPACK_PACKAGE_VENDOR "Gamos Collaboration")
...
Its areas of application include high energy, nuclear and accelerator physics, as well as studies in medical and space science (http://www.gamos.org).
The two main reference papers for Gamos are published in Nuclear Instruments and Methods in Physics Research A 506 (2003) 250-303, and IEEE Transactions on Nuclear Science 53 No. 1 (2006) 270-278.
...
set(CPACK_PACKAGE_INSTALL_DIRECTORY "Gamos ${Gamos_VERSION_MAJOR}.${Gamos_VERSION_MINOR}")
if(CMAKE_BUILD_TYPE STREQUAL Release)
  set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}-${Gamos_VERSION}-${CMAKE_SYSTEM_NAME}")
else()
  set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}-${Gamos_VERSION}-${CMAKE_SYSTEM_NAME}-${CMAKE_BUILD_TYPE}")
endif()
...
cpack_add_component(Development 
    ...
    DESCRIPTION "Install all files needed for developing Gamos applications (headers, makefiles, etc.)"
    INSTALL_TYPES developer full
)

# - Components for Runtime
cpack_add_component(Runtime 
    DISPLAY_NAME "Gamos runtime Libraries" 
    DESCRIPTION "Install all Gamos libraries"
...
cpack_add_component(Examples 
    ...
    DESCRIPTION "Install all Gamos examples"
    INSTALL_TYPES full developer
)

# - Components for Data
cpack_add_component(Data 
    DISPLAY_NAME "Gamos Data Files" 
    DESCRIPTION "Install all Gamos data files"
    INSTALL_TYPES full
)
