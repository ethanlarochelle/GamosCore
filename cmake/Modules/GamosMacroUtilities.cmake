# GamosMacroUtilities - useful macros and functions for generic tasks
#
# CMake Extensions
# ----------------
...
# General Gamos
# --------------
# macro gamos_add_feature(<NAME> <DOCSTRING>)
#       Add a Gamos feature, whose activation is specified by the
#       existence of the variable <NAME>, to the list of enabled/disabled
#       features, plus a docstring describing the feature
#
# macro gamos_print_enabled_features()
#       Print enabled Gamos features plus their docstrings.
#
# Datasets
# --------
# TODO: Move to dedicated datasets module
# function gamos_latest_version(<dir> <name> <output variable>)
...
# function gamos_add_unit_tests(test1 test2 ... [dir1 ...]
#                                INCLUDE_DIRS dir1 dir2 ...
#                                LIBRARIES library1 library2 ...)
#

include(GamosMacroDefineModule)
...
#       features, plus a docstring describing the feature
#
macro(GAMOS_ADD_FEATURE _var _description)
  if(${_var})
    set_property(GLOBAL APPEND PROPERTY GAMOS_ENABLED_FEATURES ${_var})
  else(${_var})
    set_property(GLOBAL APPEND PROPERTY GAMOS_DISABLED_FEATURES ${_var})
  endif(${_var})
...
#
macro(GAMOS_PRINT_ENABLED_FEATURES)
  set(_currentFeatureText "The following Gamos features are enabled:")
  get_property(_enabledFeatures GLOBAL PROPERTY GAMOS_ENABLED_FEATURES)
...
#          of output variable to the full path to the dataset
#
function(GAMOS_LATEST_VERSION dir name var)
