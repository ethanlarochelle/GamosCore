...
if(CMAKE_COMPILER_IS_GNUCXX OR CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  ...
  # Extra Gamos modes
  # - TestRelease
  set(CMAKE_CXX_FLAGS_TESTRELEASE_INIT "-g -DGmDEBUG_VERBOSE -DGmFPE_DEBUG")
...
if(MSVC)
  ...
  # Extra modes
  set(CMAKE_CXX_FLAGS_TESTRELEASE_INIT "-MDd -Zi -GmDEBUG_VERBOSE")
...
if(CMAKE_CXX_COMPILER MATCHES "icpc.*|icc.*")
  ...
  # Extra modes
  set(CMAKE_CXX_FLAGS_TESTRELEASE_INIT "-g -GmDEBUG_VERBOSE")
  set(CMAKE_CXX_FLAGS_MAINTAINER_INIT "-g")
...
# None are tested...
# Whilst these use flags taken from existing Gamos setup, may want to see if
