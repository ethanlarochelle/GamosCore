...
# As sources.cmake lists source files of Gamos explicitely, we can often
...
configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/Templates/gamos_validate_sources.cmake.in
  ${PROJECT_BINARY_DIR}/gamos_validate_sources.cmake
  @ONLY
  )

# Create the target
add_custom_target(validate_sources
  COMMAND ${CMAKE_COMMAND} -P ${PROJECT_BINARY_DIR}/gamos_validate_sources.cmake
  COMMENT "Validating Gamos module sources"
  )
