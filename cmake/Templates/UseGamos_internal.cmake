# - Internal Use file for Gamos
# This file is designed for inclusion by the UseGamos.cmake file, but
# only in the build tree. It contains functions and macros that are only
# intended to help in building the Gamos tests.
#
...
#----------------------------------------------------------------------------
# function GAMOS_LINK_LIBRARY( <name> source1 source2 ...
#                               [TYPE STATIC|SHARED] 
#                               LIBRARIES library1 library2 ... )
#
function(GAMOS_LINK_LIBRARY library)
  ...
  if(WIN32 AND ARG_TYPE STREQUAL SHARED)
    ...
    set_target_properties(${library} PROPERTIES LINK_INTERFACE_LIBRARIES ${ARG_LIBRARIES} ${Gamos_LIBRARIES})
  else()
    add_library( ${library} ${ARG_TYPE} ${sources})
    target_link_libraries(${library} ${ARG_LIBRARIES} ${Gamos_LIBRARIES})
  endif()
...
#----------------------------------------------------------------------------
# function GAMOS_EXECUTABLE( <name> source1 source2 ...
#                             LIBRARIES library1 library2 ... )
#
function(GAMOS_EXECUTABLE executable)
  ...
  include_directories(BEFORE ${CMAKE_CURRENT_SOURCE_DIR}/include ${GAMOS_INCLUDE_DIR})

  add_executable(${executable} EXCLUDE_FROM_ALL ${sources})
  target_link_libraries(${executable} ${ARG_LIBRARIES} ${Gamos_LIBRARIES} )
  set_target_properties(${executable} PROPERTIES OUTPUT_NAME ${executable})
endfunction()


#----------------------------------------------------------------------------
# function GAMOS_ADD_TEST( <name> COMMAND cmd [arg1... ] 
...
#
function(GAMOS_ADD_TEST test)
  if(NOT CMAKE_PROJECT_NAME STREQUAL Gamos)
    message(WARNING "function GAMOS_ADD_TEST is only for internal Gamos usage")
    return()
  endif()
  ...
  if(_len LESS 1)
    if(NOT ARG_BUILD)
      message(FATAL_ERROR "GAMOS_ADD_TEST: command is mandatory (without build)")
    endif()
  else()
  ...
  set(_driver ${CMAKE_SOURCE_DIR}/cmake/Modules/GamosTestDriver.cmake)
  if(NOT EXISTS ${_driver})
    message(FATAL_ERROR "GAMOS_ADD_TEST: GamosTestDriver.cmake not found!")
  endif()
  ...
  if(ARG_BUILD)
    ...
    if(NOT ARG_PROJECT)
       if(NOT PROJECT_NAME STREQUAL "Gamos")
    ...
    set_property(TEST ${test} PROPERTY ENVIRONMENT Gamos_DIR=${CMAKE_BINARY_DIR})
    if(ARG_FAILREGEX)
